...
/**
 * OutgoController implements the CRUD actions for OutgoType model.
 */
class OutgoController extends Controller
{
    ...
    /**
     * Displays a single OutgoType model.
     * @param integer $id
     * @return mixed
